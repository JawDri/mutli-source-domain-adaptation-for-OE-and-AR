...
class Discriminator(nn.Module):
    def __init__(self):
        ...
        self.conv6_1 = nn.Conv1d(32, 256, kernel_size=3, padding=1)
        ...
        self.conv7_1 = nn.Conv1d(256, 512, kernel_size=3, padding=1)
        self.relu7_1 = nn.ReLU(inplace=True)
        self.conv7_2 = nn.Conv1d(512, 254, kernel_size=3)
        self.relu7_2 = nn.ReLU(inplace=True)

        self.fc8 = nn.Linear(254, 256)
